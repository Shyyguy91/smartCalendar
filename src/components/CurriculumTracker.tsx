...
interface CurriculumTrackerProps {
  ...
  onImportWeeklyPlan?: () => void;
}

const statusCycle: LessonStatus[] = ["Not Started", "In Progress", "Completed"];

export default function CurriculumTracker({ tracks, onChange, onSync, onImportWeeklyPlan }: CurriculumTrackerProps) {
